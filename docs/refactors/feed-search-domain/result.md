...
| feed/post/search 관련 테스트(`testPathPatterns` 정규식으로 feed/PostCard/PostHeader/PostMedia/search 매칭) | 13 suites / 72 tests                                                                      | **14 suites / 82 tests**(+1 suite, +10 tests, 회귀 없음)                                                              |
